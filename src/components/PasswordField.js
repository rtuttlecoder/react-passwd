...
class PasswordField extends Component {
    ...
    render () {
        ...
        const strengthClass = ['strength-meter mt-2', passwordLength > 0 ? 'visible' : 'invisibile'].join(' ').trim();

        return (
            <Fragment>
                <div className="position-relative">
                    <FormField type="password" validator={this.validatePasswordStrength} onStateChanged={this.stateChanged} {...restProps}>
